...
const en: Catalog = {
  ...
  'setup.prompt.saveOperatorProfile': 'Save provider as default in operator profile ({path})?',
...
const ja: Catalog = {
  ...
  'setup.prompt.saveOperatorProfile': 'operator profile（{path}）に既定 provider として保存しますか？',

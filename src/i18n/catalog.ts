...
export const MESSAGE_KEYS = [
  ...
  'setup.prompt.probingProvidersNotice',
  'setup.prompt.probingProvider',
  'setup.prompt.selectLlmModel',
  ...
  'setup.llm.noProvidersAvailable',
  'setup.llm.modelsUnavailable',
  'setup.llm.authHint',
  'setup.llm.modelLabelDefault',
...
const en: Catalog = {
  ...
  'setup.prompt.probingProvidersNotice': 'Probing installed LLM providers (up to about 1 minute)...',
  'setup.prompt.probingProvider': 'Probing {provider} ({current}/{total})...',
  'setup.prompt.selectLlmModel': 'Select model',
  ...
  'setup.llm.noProvidersAvailable': 'No LLM providers are available on this machine. Install a provider CLI and re-run setup.',
  'setup.llm.modelsUnavailable': 'Could not list models for {provider}. Using provider default choices.',
  'setup.llm.authHint': '{provider} may require authentication before models are available. Complete sign-in separately if model discovery fails.',
  'setup.llm.modelLabelDefault': 'Provider default',
...
const ja: Catalog = {
  ...
  'setup.prompt.probingProvidersNotice': 'インストール済み LLM provider を検出しています（最大約1分）...',
  'setup.prompt.probingProvider': '{provider} を検出中 ({current}/{total})...',
  'setup.prompt.selectLlmModel': 'model を選択',
  ...
  'setup.llm.noProvidersAvailable': '利用可能な LLM provider がありません。CLI をインストールして setup を再実行してください。',
  'setup.llm.modelsUnavailable': '{provider} の model 一覧を取得できませんでした。provider 既定の選択肢を使用します。',
  'setup.llm.authHint': '{provider} は認証が必要な場合があります。model 取得に失敗した場合は別途サインインしてください。',
  'setup.llm.modelLabelDefault': 'provider 既定',

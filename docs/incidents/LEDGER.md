...
| codebase-review-2026-09-13#REG-2026-028 | Validation recordings preserve content identity and repository integrity | fixed | See review resolution for reproduced boundary failure | Validation persistence accepts repeat recordings, distinguishes changed aggregates, and rejects invalid outcomes without raw schema dumps. | REG-2026-028 | protected | none |
| codebase-review-2026-09-13#REG-2026-029 | Repository intake and dependency analysis stay bounded and accurate | fixed | See review resolution for reproduced boundary failure | Untrusted sources stay inside versioned bounded intake for every language and dependency metrics count actual modules without enumerating every path. | REG-2026-029 | protected | none |
| codebase-review-2026-09-13#REG-2026-030 | Semantic execution obeys operator scope and repository isolation | fixed | See review resolution for reproduced boundary failure | Providers start outside repository configuration, exclude the actual target from executable search, and receive the operator-selected source scope while partial profiles remain inactive. | REG-2026-030 | protected | none |
| codebase-review-2026-09-13#REG-2026-031 | Calibration reads are bounded and contained | fixed | See review resolution for reproduced boundary failure | Calibration is a bounded regular repository file and diagnostics never echo its invalid content. | REG-2026-031 | protected | none |
| codebase-review-2026-09-13#REG-2026-032 | CLI validates options before diagnosis and composes one setup JSON | fixed | See review resolution for reproduced boundary failure | Setup scan keeps stdout a single JSON value and diff rejects format/view before intake. | REG-2026-032 | protected | none |
| codebase-review-2026-09-13#REG-2026-033 | Ineligible semantic findings cannot dilute risk | fixed | See review resolution for reproduced boundary failure | Findings with no scoring support stay out of the axis aggregate. | REG-2026-033 | protected | none |
| codebase-review-2026-09-13#REG-2026-034 | Untrusted report values cannot inject Markdown | fixed | See review resolution for reproduced boundary failure | Markdown renders untrusted dynamic text without executable HTML, images, injected headings or table separators. | REG-2026-034 | protected | none |
| codebase-review-2026-09-13#REG-2026-035 | Harness errors identify inputs and reject backslash segments | fixed | See review resolution for reproduced boundary failure | Invalid harness fields and paths are identified and backslash path segments fail validation. | REG-2026-035 | protected | none |

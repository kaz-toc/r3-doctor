...
| codebase-review-2026-09-13#REG-2026-029 | Repository intake and dependency analysis stay bounded and accurate | fixed | See review resolution for reproduced boundary failure | Untrusted sources stay inside bounded intake and dependency metrics count actual modules without enumerating every path. | REG-2026-029 | protected | none |
| codebase-review-2026-09-13#REG-2026-030 | Semantic execution obeys operator scope and repository isolation | fixed | See review resolution for reproduced boundary failure | Providers start outside repository configuration and receive the operator-selected source scope while partial profiles remain inactive. | REG-2026-030 | protected | none |
